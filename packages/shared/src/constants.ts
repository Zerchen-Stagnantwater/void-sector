...
//   If you change a value, it changes for both.
// ============================================
...
export const C = {
  ...
  // Player start cols — spread across grid
  PLAYER_START_COLS: [10, 18, 26, 34] as readonly number[],

} as const;

// ---------- Player identity ----------
// Visual identity per slot — used by client renderer
// and client event handlers.
